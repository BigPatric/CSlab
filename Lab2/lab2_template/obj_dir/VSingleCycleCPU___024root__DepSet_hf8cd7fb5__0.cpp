...
VL_INLINE_OPT void VSingleCycleCPU___024root___nba_sequent__TOP__0(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__rst) {
        if (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__memWrite) {
            vlSelf->__Vdlyvval__SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory__v0 
                = (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__writeData 
                   >> 0x18U);
            ...
            vlSelf->__Vdlyvdim0__SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory__v0 
                = (0x7fU & ((IData)(3U) + vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address));
            vlSelf->__Vdlyvval__SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory__v1 
                = (0xffU & (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__writeData 
                            >> 0x10U));
            vlSelf->__Vdlyvdim0__SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory__v1 
                = (0x7fU & ((IData)(2U) + vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address));
            ...
            vlSelf->__Vdlyvdim0__SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory__v2 
                = (0x7fU & ((IData)(1U) + vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address));
            ...
            vlSelf->__Vdlyvdim0__SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory__v3 
                = (0x7fU & vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address);
        }
    } else {
...
VL_INLINE_OPT void VSingleCycleCPU___024root___nba_sequent__TOP__1(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->SingleCycleCPU__DOT__m_Register__DOT__rst) {
        if (vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regWrite) {
            __Vdlyvval__SingleCycleCPU__DOT__m_Register__DOT__regs__v0 
                = ((0U == (IData)(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__writeReg))
                    ? 0U : vlSelf->SingleCycleCPU__DOT__m_Register__DOT__writeData);
            __Vdlyvset__SingleCycleCPU__DOT__m_Register__DOT__regs__v0 = 1U;
            __Vdlyvdim0__SingleCycleCPU__DOT__m_Register__DOT__regs__v0 
                = vlSelf->SingleCycleCPU__DOT__m_Register__DOT__writeReg;
        }
    } else {
...
VL_INLINE_OPT void VSingleCycleCPU___024root___nba_sequent__TOP__2(VSingleCycleCPU___024root* vlSelf) {
    ...
    // Body
    vlSelf->SingleCycleCPU__DOT__m_PC__DOT__pc_o = 
        ((IData)(vlSelf->SingleCycleCPU__DOT__m_PC__DOT__rst)
          ? 0U : vlSelf->SingleCycleCPU__DOT__m_PC__DOT__pc_i);
}
...
VL_INLINE_OPT void VSingleCycleCPU___024root___nba_sequent__TOP__3(VSingleCycleCPU___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__memRead) {
        vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData 
            = ((0xffffffU & vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData) 
               | (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory
                  [(0x7fU & ((IData)(3U) + vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address))] 
                  << 0x18U));
        vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData 
            = ((0xff00ffffU & vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData) 
               | (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory
                  [(0x7fU & ((IData)(2U) + vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address))] 
                  << 0x10U));
        vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData 
            = ((0xffff00ffU & vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData) 
               | (vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory
                  [(0x7fU & ((IData)(1U) + vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address))] 
                  << 8U));
        vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData 
            = ((0xffffff00U & vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__readData) 
               | vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__data_memory
               [(0x7fU & vlSelf->SingleCycleCPU__DOT__m_DataMemory__DOT__address)]);
    }
}
