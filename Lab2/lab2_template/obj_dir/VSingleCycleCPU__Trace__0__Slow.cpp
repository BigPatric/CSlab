...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+94,"pc_next", false,-1, 31,0);
    tracep->declBus(c+46,"pc_plus4", false,-1, 31,0);
    tracep->declBus(c+47,"pc_branch", false,-1, 31,0);
    tracep->declBus(c+48,"instruction", false,-1, 31,0);
    tracep->declBus(c+49,"imm_gen_out", false,-1, 31,0);
    tracep->declBus(c+57,"reg_read_data1", false,-1, 31,0);
    tracep->declBus(c+58,"reg_read_data2", false,-1, 31,0);
    ...
    tracep->declBit(c+52,"funct7", false,-1);
    tracep->declBit(c+97,"branch_eq", false,-1);
    tracep->declBit(c+59,"branch_lt", false,-1);
    ...
    tracep->declBus(c+8,"mem_to_reg", false,-1, 1,0);
    tracep->declBus(c+9,"alu_op", false,-1, 1,0);
    tracep->declBus(c+10,"write_data_sel", false,-1, 1,0);
    tracep->declBus(c+11,"pc_sel", false,-1, 1,0);
    tracep->declBus(c+53,"shifted_imm", false,-1, 31,0);
    ...
    tracep->declBit(c+97,"zero", false,-1);
    ...
    tracep->declBus(c+11,"PCSel", false,-1, 1,0);
    ...
    tracep->declBit(c+60,"clk", false,-1);
    tracep->declBit(c+61,"rst", false,-1);
    tracep->declBus(c+94,"pc_i", false,-1, 31,0);
    ...
    tracep->declBit(c+61,"rst", false,-1);
    tracep->declBit(c+7,"regWrite", false,-1);
    tracep->declBus(c+54,"readReg1", false,-1, 4,0);
    tracep->declBus(c+55,"readReg2", false,-1, 4,0);
    tracep->declBus(c+56,"writeReg", false,-1, 4,0);
    tracep->declBus(c+96,"writeData", false,-1, 31,0);
    tracep->declBus(c+57,"readData1", false,-1, 31,0);
    tracep->declBus(c+58,"readData2", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+9,((3U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                   >> 3U))),2);
    bufp->fullCData(oldp+10,(((1U == (3U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                            >> 5U)))
                               ? 1U : 0U)),2);
    ...
    bufp->fullIData(oldp+47,((vlSelf->SingleCycleCPU__DOT__pc_current 
                              + (vlSelf->SingleCycleCPU__DOT__imm_gen_out 
                                 << 1U))),32);
    bufp->fullIData(oldp+48,(vlSelf->SingleCycleCPU__DOT__instruction),32);
    bufp->fullIData(oldp+49,(vlSelf->SingleCycleCPU__DOT__imm_gen_out),32);
    bufp->fullCData(oldp+50,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (7U & ((IData)(vlSelf->__VdfgTmp_hebd63ba7__0) 
                                             >> 4U)))),3);
    bufp->fullCData(oldp+51,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (0x7fU & (IData)(vlSelf->__VdfgTmp_hebd05efc__0)))),7);
    bufp->fullBit(oldp+52,(((0x80U > vlSelf->SingleCycleCPU__DOT__pc_current) 
                            & ((IData)(vlSelf->__VdfgTmp_hb17e49cd__0) 
                               >> 6U))));
    bufp->fullIData(oldp+53,((vlSelf->SingleCycleCPU__DOT__imm_gen_out 
                              << 1U)),32);
    bufp->fullCData(oldp+54,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_hca52c8c2__0 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+55,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_hc3307145__0 
                                                >> 0x14U)))),5);
    bufp->fullCData(oldp+56,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    bufp->fullIData(oldp+57,(vlSelf->SingleCycleCPU__DOT__reg_read_data1),32);
    bufp->fullIData(oldp+58,(vlSelf->SingleCycleCPU__DOT__reg_read_data2),32);
    bufp->fullBit(oldp+59,((VL_LTS_III(32, vlSelf->SingleCycleCPU__DOT__reg_read_data1, vlSelf->SingleCycleCPU__DOT__reg_read_data2)
                             ? 1U : 0U)));
    ...
    bufp->fullIData(oldp+94,(((0U == (3U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                            >> 8U)))
    ...
    bufp->fullBit(oldp+97,(vlSelf->SingleCycleCPU__DOT__branch_eq));
