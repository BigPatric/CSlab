...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+65+i*1,"r", true,(i+0), 31,0);
    }
    ...
    tracep->declBus(c+33,"pc_current", false,-1, 31,0);
    tracep->declBus(c+45,"pc_next", false,-1, 31,0);
    tracep->declBus(c+34,"pc_plus4", false,-1, 31,0);
    tracep->declBus(c+35,"pc_branch", false,-1, 31,0);
    tracep->declBus(c+36,"instruction", false,-1, 31,0);
    tracep->declBus(c+37,"imm_gen_out", false,-1, 31,0);
    tracep->declBus(c+46,"reg_read_data1", false,-1, 31,0);
    tracep->declBus(c+47,"reg_read_data2", false,-1, 31,0);
    tracep->declBus(c+48,"alu_result", false,-1, 31,0);
    tracep->declBus(c+97,"mem_read_data", false,-1, 31,0);
    tracep->declBus(c+98,"write_data", false,-1, 31,0);
    tracep->declBus(c+49,"alu_src_b", false,-1, 31,0);
    tracep->declBus(c+50,"alu_control", false,-1, 3,0);
    tracep->declBus(c+38,"funct3", false,-1, 2,0);
    tracep->declBus(c+39,"opcode", false,-1, 6,0);
    tracep->declBit(c+40,"funct7", false,-1);
    tracep->declBit(c+51,"branch_eq", false,-1);
    tracep->declBit(c+52,"branch_lt", false,-1);
    tracep->declBit(c+53,"mem_read", false,-1);
    tracep->declBit(c+54,"mem_write", false,-1);
    tracep->declBit(c+55,"alu_src", false,-1);
    tracep->declBit(c+56,"reg_write", false,-1);
    tracep->declBit(c+57,"jump", false,-1);
    tracep->declBus(c+58,"mem_to_reg", false,-1, 1,0);
    tracep->declBus(c+59,"alu_op", false,-1, 1,0);
    tracep->declBus(c+60,"write_data_sel", false,-1, 1,0);
    tracep->declBus(c+61,"pc_sel", false,-1, 1,0);
    tracep->declBus(c+41,"shifted_imm", false,-1, 31,0);
    ...
    tracep->declBit(c+51,"BrEq", false,-1);
    tracep->declBit(c+52,"BrLT", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+58,"memtoReg", false,-1, 1,0);
    tracep->declBus(c+59,"ALUOp", false,-1, 1,0);
    tracep->declBit(c+54,"memWrite", false,-1);
    tracep->declBit(c+55,"ALUSrc", false,-1);
    tracep->declBit(c+56,"regWrite", false,-1);
    tracep->declBus(c+61,"PCSel", false,-1, 1,0);
    tracep->declBus(c+62,"ctrl", false,-1, 7,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+48,"s2", false,-1, 31,0);
    ...
    tracep->declBus(c+101,"s2", false,-1, 31,0);
    ...
    tracep->declBit(c+64,"rst", false,-1);
    tracep->declBit(c+56,"regWrite", false,-1);
    tracep->declBus(c+42,"readReg1", false,-1, 4,0);
    tracep->declBus(c+43,"readReg2", false,-1, 4,0);
    tracep->declBus(c+44,"writeReg", false,-1, 4,0);
    tracep->declBus(c+98,"writeData", false,-1, 31,0);
    tracep->declBus(c+46,"readData1", false,-1, 31,0);
    tracep->declBus(c+47,"readData2", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
    ...
    tracep->declBus(c+41,"o", false,-1, 31,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+33,(vlSelf->SingleCycleCPU__DOT__pc_current),32);
    bufp->fullIData(oldp+34,(((IData)(4U) + vlSelf->SingleCycleCPU__DOT__pc_current)),32);
    bufp->fullIData(oldp+35,((vlSelf->SingleCycleCPU__DOT__pc_current 
                              + (vlSelf->SingleCycleCPU__DOT__imm_gen_out 
                                 << 1U))),32);
    bufp->fullIData(oldp+36,(vlSelf->SingleCycleCPU__DOT__instruction),32);
    bufp->fullIData(oldp+37,(vlSelf->SingleCycleCPU__DOT__imm_gen_out),32);
    bufp->fullCData(oldp+38,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (7U & ((IData)(vlSelf->__VdfgTmp_hebd63ba7__0) 
                                             >> 4U)))),3);
    bufp->fullCData(oldp+39,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (0x7fU & (IData)(vlSelf->__VdfgTmp_hebd05efc__0)))),7);
    bufp->fullBit(oldp+40,(((0x80U > vlSelf->SingleCycleCPU__DOT__pc_current) 
                            & ((IData)(vlSelf->__VdfgTmp_hb17e49cd__0) 
                               >> 6U))));
    bufp->fullIData(oldp+41,((vlSelf->SingleCycleCPU__DOT__imm_gen_out 
                              << 1U)),32);
    bufp->fullCData(oldp+42,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_hca52c8c2__0 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+43,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_current)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_hc3307145__0 
                                                >> 0x14U)))),5);
    bufp->fullCData(oldp+44,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    bufp->fullIData(oldp+45,(vlSelf->SingleCycleCPU__DOT__pc_next),32);
    bufp->fullIData(oldp+46,(vlSelf->SingleCycleCPU__DOT__reg_read_data1),32);
    bufp->fullIData(oldp+47,(vlSelf->SingleCycleCPU__DOT__reg_read_data2),32);
    bufp->fullIData(oldp+48,(vlSelf->SingleCycleCPU__DOT__alu_result),32);
    bufp->fullIData(oldp+49,(vlSelf->SingleCycleCPU__DOT__alu_src_b),32);
    bufp->fullCData(oldp+50,(vlSelf->SingleCycleCPU__DOT__alu_control),4);
    bufp->fullBit(oldp+51,((vlSelf->SingleCycleCPU__DOT__reg_read_data1 
                            == vlSelf->SingleCycleCPU__DOT__reg_read_data2)));
    bufp->fullBit(oldp+52,(VL_LTS_III(32, vlSelf->SingleCycleCPU__DOT__reg_read_data1, vlSelf->SingleCycleCPU__DOT__reg_read_data2)));
    bufp->fullBit(oldp+53,(vlSelf->SingleCycleCPU__DOT__mem_read));
    bufp->fullBit(oldp+54,((1U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                  >> 2U))));
    bufp->fullBit(oldp+55,((1U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                  >> 1U))));
    bufp->fullBit(oldp+56,((1U & (IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl))));
    bufp->fullBit(oldp+57,((0U == vlSelf->SingleCycleCPU__DOT__alu_result)));
    bufp->fullCData(oldp+58,((3U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                    >> 5U))),2);
    bufp->fullCData(oldp+59,((3U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                    >> 3U))),2);
    bufp->fullCData(oldp+60,(((1U == (3U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                            >> 5U)))
                               ? 1U : 0U)),2);
    bufp->fullCData(oldp+61,(vlSelf->SingleCycleCPU__DOT__pc_sel),2);
    bufp->fullCData(oldp+62,(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl),8);
    bufp->fullBit(oldp+63,(vlSelf->clk));
    bufp->fullBit(oldp+64,(vlSelf->start));
    bufp->fullIData(oldp+65,(vlSelf->r[0]),32);
    bufp->fullIData(oldp+66,(vlSelf->r[1]),32);
    bufp->fullIData(oldp+67,(vlSelf->r[2]),32);
    bufp->fullIData(oldp+68,(vlSelf->r[3]),32);
    bufp->fullIData(oldp+69,(vlSelf->r[4]),32);
    bufp->fullIData(oldp+70,(vlSelf->r[5]),32);
    bufp->fullIData(oldp+71,(vlSelf->r[6]),32);
    bufp->fullIData(oldp+72,(vlSelf->r[7]),32);
    bufp->fullIData(oldp+73,(vlSelf->r[8]),32);
    bufp->fullIData(oldp+74,(vlSelf->r[9]),32);
    bufp->fullIData(oldp+75,(vlSelf->r[10]),32);
    bufp->fullIData(oldp+76,(vlSelf->r[11]),32);
    bufp->fullIData(oldp+77,(vlSelf->r[12]),32);
    bufp->fullIData(oldp+78,(vlSelf->r[13]),32);
    bufp->fullIData(oldp+79,(vlSelf->r[14]),32);
    bufp->fullIData(oldp+80,(vlSelf->r[15]),32);
    bufp->fullIData(oldp+81,(vlSelf->r[16]),32);
    bufp->fullIData(oldp+82,(vlSelf->r[17]),32);
    bufp->fullIData(oldp+83,(vlSelf->r[18]),32);
    bufp->fullIData(oldp+84,(vlSelf->r[19]),32);
    bufp->fullIData(oldp+85,(vlSelf->r[20]),32);
    bufp->fullIData(oldp+86,(vlSelf->r[21]),32);
    bufp->fullIData(oldp+87,(vlSelf->r[22]),32);
    bufp->fullIData(oldp+88,(vlSelf->r[23]),32);
    bufp->fullIData(oldp+89,(vlSelf->r[24]),32);
    bufp->fullIData(oldp+90,(vlSelf->r[25]),32);
    bufp->fullIData(oldp+91,(vlSelf->r[26]),32);
    bufp->fullIData(oldp+92,(vlSelf->r[27]),32);
    bufp->fullIData(oldp+93,(vlSelf->r[28]),32);
    bufp->fullIData(oldp+94,(vlSelf->r[29]),32);
    bufp->fullIData(oldp+95,(vlSelf->r[30]),32);
    bufp->fullIData(oldp+96,(vlSelf->r[31]),32);
    bufp->fullIData(oldp+97,(vlSelf->SingleCycleCPU__DOT__mem_read_data),32);
    bufp->fullIData(oldp+98,(vlSelf->SingleCycleCPU__DOT__write_data),32);
