...
VL_INLINE_OPT void VALU___024root___ico_sequent__TOP__0(VALU___024root* vlSelf) {
    ...
    // Body
    vlSelf->ALUOut = ((8U & (IData)(vlSelf->ALUctl))
                       ? ((4U & (IData)(vlSelf->ALUctl))
                           ? 0U : ((2U & (IData)(vlSelf->ALUctl))
                                    ? 0U : ((1U & (IData)(vlSelf->ALUctl))
                                             ? ((vlSelf->A 
                                                 < vlSelf->B)
                                                 ? 1U
                                                 : 0U)
                                             : 0U)))
                       : ((4U & (IData)(vlSelf->ALUctl))
                           ? ((2U & (IData)(vlSelf->ALUctl))
                               ? ((1U & (IData)(vlSelf->ALUctl))
...
void VALU___024root___eval_debug_assertions(VALU___024root* vlSelf) {
    ...
    // Body
    if (VL_UNLIKELY((vlSelf->ALUctl & 0xf0U))) {
        Verilated::overWidthError("ALUctl");}
}
#endif  // VL_DEBUG
