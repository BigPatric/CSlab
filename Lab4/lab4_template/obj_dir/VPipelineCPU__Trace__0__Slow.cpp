...
VL_ATTR_COLD void VPipelineCPU___024root__trace_init_sub__TOP__0(VPipelineCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+56,"pc_branch", false,-1, 31,0);
    tracep->declBus(c+57,"instruct", false,-1, 31,0);
    ...
    tracep->declBus(c+61,"alu_src_b", false,-1, 31,0);
    ...
    tracep->declBit(c+62,"jump", false,-1);
    tracep->declBus(c+94,"mem_to_reg", false,-1, 1,0);
    tracep->declBus(c+95,"alu_op", false,-1, 1,0);
    tracep->declBus(c+96,"pc_sel", false,-1, 1,0);
    tracep->declBus(c+63,"shift_one", false,-1, 31,0);
    tracep->declBus(c+64,"alu_result_EX_MEM", false,-1, 31,0);
    ...
    tracep->declBit(c+66,"mem_read_EX_MEM", false,-1);
    tracep->declBit(c+67,"reg_write_EX_MEM", false,-1);
    ...
    tracep->declBus(c+68,"instruct_IF_ID", false,-1, 31,0);
    tracep->declBit(c+69,"RePC", false,-1);
    tracep->declBit(c+70,"Flush_HD", false,-1);
    tracep->declBus(c+71,"opcode", false,-1, 6,0);
    tracep->declBus(c+72,"funct3", false,-1, 2,0);
    tracep->declBit(c+73,"funct7", false,-1);
    ...
    tracep->declBus(c+140,"pc_S_out", false,-1, 31,0);
    tracep->declBit(c+77,"reg_write_ID_EX", false,-1);
    ...
    tracep->declBus(c+79,"writeReg_ID_EX", false,-1, 4,0);
    tracep->declBus(c+16,"funct3_ID_EX", false,-1, 2,0);
    tracep->declBit(c+17,"funct7_ID_EX", false,-1);
    tracep->declBit(c+80,"id_ForwardA", false,-1);
    tracep->declBit(c+81,"id_ForwardB", false,-1);
    tracep->declBus(c+82,"ex_ForwardA", false,-1, 1,0);
    tracep->declBus(c+83,"ex_ForwardB", false,-1, 1,0);
    tracep->declBus(c+84,"reg_read_data1_ID_EX_mux", false,-1, 31,0);
    tracep->declBus(c+85,"reg_read_data2_ID_EX_mux", false,-1, 31,0);
    tracep->declBus(c+18,"alu_result_MEM_WB", false,-1, 31,0);
    tracep->declBus(c+19,"mem_read_data_MEM_WB", false,-1, 31,0);
    tracep->declBus(c+86,"write_reg_MEM_WB", false,-1, 4,0);
    tracep->declBit(c+87,"reg_write_MEM_WB", false,-1);
    ...
    tracep->declBus(c+74,"id_R1", false,-1, 4,0);
    tracep->declBus(c+75,"id_R2", false,-1, 4,0);
    tracep->declBus(c+79,"ex_Rd", false,-1, 4,0);
    tracep->declBus(c+65,"mem_Rd", false,-1, 4,0);
    tracep->declBit(c+78,"ID_EX_MemRead", false,-1);
    tracep->declBit(c+66,"mem_MemRead", false,-1);
    tracep->declBit(c+69,"RePC", false,-1);
    tracep->declBit(c+70,"Flush_HD", false,-1);
    ...
    tracep->declBus(c+142,"b1", false,-1, 9,0);
    tracep->declBus(c+143,"b2", false,-1, 9,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+64,"address", false,-1, 31,0);
    ...
    tracep->declBit(c+102,"clk", false,-1);
    tracep->declBit(c+103,"rst", false,-1);
    tracep->declBus(c+59,"alu_result_i", false,-1, 31,0);
    tracep->declBus(c+12,"pc_4_i", false,-1, 31,0);
    tracep->declBus(c+85,"readData2_i", false,-1, 31,0);
    tracep->declBus(c+79,"write_reg_i", false,-1, 4,0);
    tracep->declBit(c+9,"mem_write_i", false,-1);
    tracep->declBit(c+78,"mem_read_i", false,-1);
    tracep->declBus(c+8,"mem_to_reg_i", false,-1, 1,0);
    tracep->declBit(c+77,"regWrite_i", false,-1);
    ...
    tracep->declBit(c+67,"regWrite_o", false,-1);
    tracep->declBit(c+4,"mem_write_o", false,-1);
    tracep->declBit(c+66,"mem_read_o", false,-1);
    tracep->declBus(c+5,"mem_to_reg_o", false,-1, 1,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_Forwarding_Unit ");
    tracep->declBus(c+74,"id_R1", false,-1, 4,0);
    tracep->declBus(c+75,"id_R2", false,-1, 4,0);
    tracep->declBus(c+79,"ex_R1", false,-1, 4,0);
    tracep->declBus(c+79,"ex_R2", false,-1, 4,0);
    tracep->declBus(c+65,"mem_Rd", false,-1, 4,0);
    tracep->declBus(c+86,"wb_Rd", false,-1, 4,0);
    tracep->declBit(c+67,"mem_RegWrite", false,-1);
    tracep->declBit(c+87,"wb_RegWrite", false,-1);
    tracep->declBit(c+80,"id_ForwardA", false,-1);
    tracep->declBit(c+81,"id_ForwardB", false,-1);
    tracep->declBus(c+82,"ex_ForwardA", false,-1, 1,0);
    tracep->declBus(c+83,"ex_ForwardB", false,-1, 1,0);
    ...
    tracep->declBus(c+72,"funct3_i", false,-1, 2,0);
    tracep->declBit(c+73,"funct7_i", false,-1);
    ...
    tracep->declBus(c+58,"imm_i", false,-1, 31,0);
    tracep->declBus(c+76,"write_reg_i", false,-1, 4,0);
    tracep->declBit(c+70,"Flush_HD", false,-1);
    tracep->declBit(c+77,"reg_write_o", false,-1);
    ...
    tracep->declBus(c+79,"write_reg_o", false,-1, 4,0);
    ...
    tracep->declBit(c+102,"clk", false,-1);
    tracep->declBit(c+103,"rst", false,-1);
    tracep->declBus(c+64,"alu_result_i", false,-1, 31,0);
    ...
    tracep->declBit(c+67,"reg_write_i", false,-1);
    ...
    tracep->declBus(c+86,"write_reg_o", false,-1, 4,0);
    tracep->declBit(c+87,"reg_write_o", false,-1);
    tracep->declBus(c+20,"mem_to_reg_o", false,-1, 1,0);
    tracep->declBus(c+21,"pc_4_o", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_Mux_ALU ");
    tracep->declBus(c+144,"size", false,-1, 31,0);
    tracep->declBit(c+10,"sel", false,-1);
    tracep->declBus(c+85,"s0", false,-1, 31,0);
    ...
    tracep->declBus(c+64,"s2", false,-1, 31,0);
    ...
    tracep->declBus(c+74,"readReg1", false,-1, 4,0);
    tracep->declBus(c+75,"readReg2", false,-1, 4,0);
    tracep->declBus(c+86,"writeReg", false,-1, 4,0);
    ...
    tracep->declBus(c+63,"o", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void VPipelineCPU___024root__trace_full_sub_0(VPipelineCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+56,(vlSelf->PipelineCPU__DOT__pc_branch),32);
    bufp->fullIData(oldp+57,(((0x80U <= vlSelf->PipelineCPU__DOT__pc_current)
    ...
    bufp->fullIData(oldp+58,(vlSelf->PipelineCPU__DOT__imm),32);
    bufp->fullIData(oldp+59,(vlSelf->PipelineCPU__DOT__alu_result),32);
    bufp->fullIData(oldp+60,(vlSelf->PipelineCPU__DOT__write_data),32);
    bufp->fullIData(oldp+61,(vlSelf->PipelineCPU__DOT__alu_src_b),32);
    bufp->fullBit(oldp+62,((0U == vlSelf->PipelineCPU__DOT__alu_result)));
    bufp->fullIData(oldp+63,((vlSelf->PipelineCPU__DOT__imm 
                              << 1U)),32);
    bufp->fullIData(oldp+64,(vlSelf->PipelineCPU__DOT__alu_result_EX_MEM),32);
    bufp->fullCData(oldp+65,(vlSelf->PipelineCPU__DOT__write_reg_EX_MEM),5);
    bufp->fullBit(oldp+66,(vlSelf->PipelineCPU__DOT__mem_read_EX_MEM));
    bufp->fullBit(oldp+67,(vlSelf->PipelineCPU__DOT__reg_write_EX_MEM));
    bufp->fullIData(oldp+68,(vlSelf->PipelineCPU__DOT__m_IF_ID_Reg__DOT__inst_t),32);
    bufp->fullBit(oldp+69,(vlSelf->PipelineCPU__DOT__RePC));
    bufp->fullBit(oldp+70,(vlSelf->PipelineCPU__DOT__Flush_HD));
    bufp->fullCData(oldp+71,((0x7fU & vlSelf->PipelineCPU__DOT__m_IF_ID_Reg__DOT__inst_t)),7);
    bufp->fullCData(oldp+72,((7U & (vlSelf->PipelineCPU__DOT__m_IF_ID_Reg__DOT__inst_t 
                                    >> 0xcU))),3);
    bufp->fullBit(oldp+73,((1U & (vlSelf->PipelineCPU__DOT__m_IF_ID_Reg__DOT__inst_t 
                                  >> 0x1eU))));
    ...
    bufp->fullCData(oldp+76,((0x1fU & (vlSelf->PipelineCPU__DOT__m_IF_ID_Reg__DOT__inst_t 
                                       >> 7U))),5);
    bufp->fullBit(oldp+77,(vlSelf->PipelineCPU__DOT__reg_write_ID_EX));
    bufp->fullBit(oldp+78,(vlSelf->PipelineCPU__DOT__mem_read_ID_EX));
    bufp->fullCData(oldp+79,(vlSelf->PipelineCPU__DOT__writeReg_ID_EX),5);
    bufp->fullBit(oldp+80,(vlSelf->PipelineCPU__DOT__id_ForwardA));
    bufp->fullBit(oldp+81,(vlSelf->PipelineCPU__DOT__id_ForwardB));
    bufp->fullCData(oldp+82,(vlSelf->PipelineCPU__DOT__ex_ForwardA),2);
    bufp->fullCData(oldp+83,(vlSelf->PipelineCPU__DOT__ex_ForwardB),2);
    bufp->fullIData(oldp+84,(vlSelf->PipelineCPU__DOT__reg_read_data1_ID_EX_mux),32);
    bufp->fullIData(oldp+85,(vlSelf->PipelineCPU__DOT__reg_read_data2_ID_EX_mux),32);
    bufp->fullCData(oldp+86,(vlSelf->PipelineCPU__DOT__write_reg_MEM_WB),5);
    bufp->fullBit(oldp+87,(vlSelf->PipelineCPU__DOT__reg_write_MEM_WB));
    ...
    bufp->fullIData(oldp+140,(((0U == (IData)(vlSelf->PipelineCPU__DOT__pc_sel))
    ...
    bufp->fullSData(oldp+142,(0x100U),10);
    bufp->fullSData(oldp+143,(0U),10);
