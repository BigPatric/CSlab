...
VL_INLINE_OPT void VPipelineCPU___024root___nba_sequent__TOP__0(VPipelineCPU___024root* vlSelf) {
    ...
    __Vtableidx2 = 0;
    // Body
    vlSelf->__Vdly__PipelineCPU__DOT__pc_current = vlSelf->PipelineCPU__DOT__pc_current;
    ...
    if (vlSelf->start) {
        ...
        vlSelf->__Vdly__PipelineCPU__DOT__pc_current = 0U;
                                            ...
                                            ((4U & (IData)(vlSelf->PipelineCPU__DOT__alu_control))
                                              ...
                                              : ((2U 
                                                 ...
                                                 ((1U 
                                                  ...
                                                  (vlSelf->PipelineCPU__DOT__reg_read_data1_ID_EX_mux 
                                                   + vlSelf->PipelineCPU__DOT__alu_src_b)))));
    vlSelf->PipelineCPU__DOT__pc_current = vlSelf->__Vdly__PipelineCPU__DOT__pc_current;
