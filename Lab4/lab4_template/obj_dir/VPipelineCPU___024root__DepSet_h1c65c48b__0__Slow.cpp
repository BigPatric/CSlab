...
VL_ATTR_COLD void VPipelineCPU___024root___stl_sequent__TOP__0(VPipelineCPU___024root* vlSelf) {
    ...
    if (((((IData)(vlSelf->PipelineCPU__DOT__reg_write_MEM_WB) 
          ...
          & ((IData)(vlSelf->PipelineCPU__DOT__write_reg_MEM_WB) 
             == (IData)(vlSelf->PipelineCPU__DOT__writeReg_ID_EX))) 
         & (~ (((IData)(vlSelf->PipelineCPU__DOT__reg_write_EX_MEM) 
                & (0U != (IData)(vlSelf->PipelineCPU__DOT__write_reg_EX_MEM))) 
               & ((IData)(vlSelf->PipelineCPU__DOT__write_reg_EX_MEM) 
                  == (IData)(vlSelf->PipelineCPU__DOT__writeReg_ID_EX)))))) {
    ...
    vlSelf->PipelineCPU__DOT__pc_branch = (vlSelf->PipelineCPU__DOT__m_IF_ID_Reg__DOT__pc_t 
...
VL_ATTR_COLD void VPipelineCPU___024root___ctor_var_reset(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->PipelineCPU__DOT__reg_read_data1_ID_EX_mux = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__reg_read_data2_ID_EX_mux = VL_RAND_RESET_I(32);
