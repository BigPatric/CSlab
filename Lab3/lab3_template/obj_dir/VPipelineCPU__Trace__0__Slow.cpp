...
VL_ATTR_COLD void VPipelineCPU___024root__trace_init_sub__TOP__0(VPipelineCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+47,"instruct", false,-1, 31,0);
    ...
    tracep->declBus(c+50,"shift_one", false,-1, 31,0);
    tracep->declBus(c+1,"pc_current_IF_ID", false,-1, 31,0);
    tracep->declBus(c+51,"pc_plus4_IF_ID", false,-1, 31,0);
    tracep->declBus(c+52,"instruct_IF_ID", false,-1, 31,0);
    tracep->declBus(c+53,"opcode", false,-1, 6,0);
    tracep->declBus(c+54,"funct3", false,-1, 2,0);
    tracep->declBit(c+55,"funct7", false,-1);
    tracep->declBus(c+56,"readReg1", false,-1, 4,0);
    tracep->declBus(c+57,"readReg2", false,-1, 4,0);
    tracep->declBus(c+58,"writeReg", false,-1, 4,0);
    tracep->declBus(c+2,"pc_current_ID_EX", false,-1, 31,0);
    tracep->declBus(c+59,"pc_plus4_ID_EX", false,-1, 31,0);
    ...
    tracep->declBus(c+60,"write_reg_ID_EX", false,-1, 4,0);
    tracep->declBit(c+9,"jump_ID_EX", false,-1);
    tracep->declBus(c+72,"alu_result_EX_MEM", false,-1, 31,0);
    tracep->declBus(c+61,"pc_plus4_EX_MEM", false,-1, 31,0);
    tracep->declBus(c+10,"reg_read_data2_EX_MEM", false,-1, 31,0);
    tracep->declBit(c+11,"jump_EX_MEM", false,-1);
    tracep->declBit(c+73,"mem_read_EX_MEM", false,-1);
    tracep->declBit(c+12,"mem_write_EX_MEM", false,-1);
    tracep->declBus(c+62,"write_reg_EX_MEM", false,-1, 4,0);
    tracep->declBus(c+63,"alu_result_MEM_WB", false,-1, 31,0);
    tracep->declBus(c+64,"mem_read_data_MEM_WB", false,-1, 31,0);
    tracep->declBus(c+65,"write_reg_MEM_WB", false,-1, 4,0);
    ...
    tracep->declBus(c+50,"b", false,-1, 31,0);
    ...
    tracep->declBus(c+59,"branch_addr_i", false,-1, 31,0);
    tracep->declBus(c+4,"reg_write_data_i", false,-1, 31,0);
    tracep->declBit(c+9,"alu_zero_i", false,-1);
    tracep->declBit(c+71,"mem_read_i", false,-1);
    tracep->declBit(c+7,"mem_write_i", false,-1);
    tracep->declBus(c+60,"write_reg_i", false,-1, 4,0);
    tracep->declBus(c+72,"alu_result_o", false,-1, 31,0);
    tracep->declBus(c+61,"branch_addr_o", false,-1, 31,0);
    tracep->declBus(c+10,"reg_write_data_o", false,-1, 31,0);
    tracep->declBit(c+11,"alu_zero_o", false,-1);
    tracep->declBit(c+73,"mem_read_o", false,-1);
    tracep->declBit(c+12,"mem_write_o", false,-1);
    tracep->declBus(c+62,"write_reg_o", false,-1, 4,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_ID_EX_Reg ");
    tracep->declBit(c+86,"clk", false,-1);
    tracep->declBit(c+87,"rst", false,-1);
    tracep->declBus(c+1,"pc_i", false,-1, 31,0);
    tracep->declBus(c+51,"pc_4_i", false,-1, 31,0);
    tracep->declBus(c+67,"reg_read_data1_i", false,-1, 31,0);
    tracep->declBus(c+68,"reg_read_data2_i", false,-1, 31,0);
    tracep->declBus(c+48,"imm_i", false,-1, 31,0);
    ...
    tracep->declBus(c+58,"write_reg_i", false,-1, 4,0);
    tracep->declBit(c+81,"jump_i", false,-1);
    tracep->declBus(c+2,"pc_o", false,-1, 31,0);
    tracep->declBus(c+59,"pc_4_o", false,-1, 31,0);
    ...
    tracep->declBus(c+60,"write_reg_o", false,-1, 4,0);
    ...
    tracep->declBus(c+46,"pc_4_i", false,-1, 31,0);
    tracep->declBus(c+47,"inst_i", false,-1, 31,0);
    tracep->declBus(c+1,"pc_o", false,-1, 31,0);
    tracep->declBus(c+51,"pc_4_o", false,-1, 31,0);
    tracep->declBus(c+52,"inst_o", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+62,"write_reg_i", false,-1, 4,0);
    tracep->declBus(c+82,"mem_to_reg_i", false,-1, 1,0);
    tracep->declBus(c+63,"alu_result_o", false,-1, 31,0);
    tracep->declBus(c+64,"reg_read_data_o", false,-1, 31,0);
    ...
    tracep->declBus(c+64,"s1", false,-1, 31,0);
    ...
    tracep->declBus(c+56,"readReg1", false,-1, 4,0);
    tracep->declBus(c+57,"readReg2", false,-1, 4,0);
    tracep->declBus(c+65,"writeReg", false,-1, 4,0);
    tracep->declBus(c+49,"writeData", false,-1, 31,0);
    ...
    tracep->declBus(c+50,"o", false,-1, 31,0);
...
VL_ATTR_COLD void VPipelineCPU___024root__trace_full_sub_0(VPipelineCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+9,(vlSelf->PipelineCPU__DOT__jump_ID_EX));
    bufp->fullIData(oldp+10,(vlSelf->PipelineCPU__DOT__reg_read_data2_EX_MEM),32);
    bufp->fullBit(oldp+11,(vlSelf->PipelineCPU__DOT__jump_EX_MEM));
    bufp->fullBit(oldp+12,(vlSelf->PipelineCPU__DOT__mem_write_EX_MEM));
    bufp->fullIData(oldp+13,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[0]),32);
    bufp->fullIData(oldp+14,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[1]),32);
    bufp->fullIData(oldp+15,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[2]),32);
    bufp->fullIData(oldp+16,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[3]),32);
    bufp->fullIData(oldp+17,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[4]),32);
    bufp->fullIData(oldp+18,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[5]),32);
    bufp->fullIData(oldp+19,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[6]),32);
    bufp->fullIData(oldp+20,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[7]),32);
    bufp->fullIData(oldp+21,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[8]),32);
    bufp->fullIData(oldp+22,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[9]),32);
    bufp->fullIData(oldp+23,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[10]),32);
    bufp->fullIData(oldp+24,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[11]),32);
    bufp->fullIData(oldp+25,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[12]),32);
    bufp->fullIData(oldp+26,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[13]),32);
    bufp->fullIData(oldp+27,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[14]),32);
    bufp->fullIData(oldp+28,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[15]),32);
    bufp->fullIData(oldp+29,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[16]),32);
    bufp->fullIData(oldp+30,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[17]),32);
    bufp->fullIData(oldp+31,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[18]),32);
    bufp->fullIData(oldp+32,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[19]),32);
    bufp->fullIData(oldp+33,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[20]),32);
    bufp->fullIData(oldp+34,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[21]),32);
    bufp->fullIData(oldp+35,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[22]),32);
    bufp->fullIData(oldp+36,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[23]),32);
    bufp->fullIData(oldp+37,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[24]),32);
    bufp->fullIData(oldp+38,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[25]),32);
    bufp->fullIData(oldp+39,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[26]),32);
    bufp->fullIData(oldp+40,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[27]),32);
    bufp->fullIData(oldp+41,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[28]),32);
    bufp->fullIData(oldp+42,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[29]),32);
    bufp->fullIData(oldp+43,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[30]),32);
    bufp->fullIData(oldp+44,(vlSelf->PipelineCPU__DOT__m_Register__DOT__regs[31]),32);
    bufp->fullIData(oldp+45,(vlSelf->PipelineCPU__DOT__pc_current),32);
    bufp->fullIData(oldp+46,(((IData)(4U) + vlSelf->PipelineCPU__DOT__pc_current)),32);
    bufp->fullIData(oldp+47,(((0x80U <= vlSelf->PipelineCPU__DOT__pc_current)
    ...
    bufp->fullIData(oldp+48,(vlSelf->PipelineCPU__DOT__imm),32);
    bufp->fullIData(oldp+49,(((0U == (IData)(vlSelf->PipelineCPU__DOT__mem_to_reg_MEM_WB))
                               ...
                               : ((1U == (IData)(vlSelf->PipelineCPU__DOT__mem_to_reg_MEM_WB))
                                   ...
                                   : ((2U == (IData)(vlSelf->PipelineCPU__DOT__mem_to_reg_MEM_WB))
                                       ...
                                       : 0U)))),32);
    bufp->fullIData(oldp+50,((vlSelf->PipelineCPU__DOT__imm 
                              << 1U)),32);
    bufp->fullIData(oldp+51,(vlSelf->PipelineCPU__DOT__pc_plus4_IF_ID),32);
    bufp->fullIData(oldp+52,(vlSelf->PipelineCPU__DOT__instruct_IF_ID),32);
    bufp->fullCData(oldp+53,((0x7fU & vlSelf->PipelineCPU__DOT__instruct_IF_ID)),7);
    bufp->fullCData(oldp+54,((7U & (vlSelf->PipelineCPU__DOT__instruct_IF_ID 
                                    >> 0xcU))),3);
    bufp->fullBit(oldp+55,((1U & (vlSelf->PipelineCPU__DOT__instruct_IF_ID 
                                  >> 0x1eU))));
    bufp->fullCData(oldp+56,((0x1fU & (vlSelf->PipelineCPU__DOT__instruct_IF_ID 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+57,((0x1fU & (vlSelf->PipelineCPU__DOT__instruct_IF_ID 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+58,((0x1fU & (vlSelf->PipelineCPU__DOT__instruct_IF_ID 
                                       >> 7U))),5);
    bufp->fullIData(oldp+59,(vlSelf->PipelineCPU__DOT__pc_plus4_ID_EX),32);
    bufp->fullCData(oldp+60,(vlSelf->PipelineCPU__DOT__write_reg_ID_EX),5);
    bufp->fullIData(oldp+61,(vlSelf->PipelineCPU__DOT__pc_plus4_EX_MEM),32);
    bufp->fullCData(oldp+62,(vlSelf->PipelineCPU__DOT__write_reg_EX_MEM),5);
    bufp->fullIData(oldp+63,(vlSelf->PipelineCPU__DOT__alu_result_MEM_WB),32);
    bufp->fullIData(oldp+64,(vlSelf->PipelineCPU__DOT__mem_read_data_MEM_WB),32);
    bufp->fullCData(oldp+65,(vlSelf->PipelineCPU__DOT__write_reg_MEM_WB),5);
